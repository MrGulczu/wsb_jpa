...
-- Patients
INSERT INTO patient (id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, address_id) VALUES (1, 'Ryszard', 'Roszko', '+48 885 598 633', 'muellerrobert@onet.pl', 'PAT001', '1996-05-12', 4);
INSERT INTO patient (id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, address_id) VALUES (2, 'Daniel', 'Ryfa', '32 569 75 88', 'klarakozok@interia.pl', 'PAT002', '1989-06-07', 6);
INSERT INTO patient (id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, address_id) VALUES (3, 'Ada', 'Halama', '+48 505 951 799', 'korneliasiedlik@hotmail.com', 'PAT003', '1970-05-22', 5);
INSERT INTO patient (id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, address_id) VALUES (4, 'Roksana', 'Perczak', '798 940 259', 'adawenzel@o2.pl', 'PAT004', '1973-09-15', 10);
INSERT INTO patient (id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, address_id) VALUES (5, 'Jędrzej', 'Horbacz', '+48 732 659 176', 'skwiraantoni@fundacja.pl', 'PAT005', '1975-01-28', 9);
