...
public class PatientTO {
    ...
    public Collection<VisitTO> getVisits() {return visits;}

    public void setVisits(Collection<VisitTO> visits) {this.visits = visits;}

    public Boolean getAllergic() {return isAllergic;}
